...
namespace IDTPApiService.Controllers
{
    ...
    * Implementation Flow:
    *                      a. Creates a payment request providing as per the provided PAIN.013 XML.
    */

    [Route("[controller]")]
    [ApiController]
    public class RequestToPay : Controller
    {        
        public RequestToPay()
        {
        ...
        /// <summary>
        /// Creates a payment request providing as per the provided PAIN.013 XML
        /// </summary>
        ...
        [HttpPost("/CreateRequestToPay", Name = "CreateRequestToPay")]
        [Authorize(Roles = IDTPRoleNames.Merchant)]
        public string CreateRequestToPay([FromBody] string xmlData)
        {
            string response;
            try
            {
                ...
                string transactionId, initiatorName, initiatorId, debitorAgentName, creditorAgentName, originalPaymentInfoId, debitorAgentBic,
                     debitorAccount, debitorName, transactionAmount, creditorAgentBIC, creditorAccount, creditorName;
                ...
                var pain014 = ISOComposer.GetDataForPAIN014(transactionId, initiatorId, initiatorName, debitorAgentBic, debitorAgentName,
                   debitorAccount, debitorName, transactionAmount, creditorAgentBIC, creditorAgentName, creditorAccount, creditorName);
