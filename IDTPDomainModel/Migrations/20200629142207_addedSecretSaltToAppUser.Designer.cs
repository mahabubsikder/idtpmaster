...
namespace IDTPDomainModel.Migrations
{
    ...
    [Migration("20200629142207_addedSecretSaltToAppUser")]
    partial class addedSecretSaltToAppUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IDTPDomainModel.FinancialInstitution", b =>
                {
                    ...
                    b.Property<string>("InstitutionLicenseNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IDTPDomainModel.Models.MasterToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MasterTokens");
                });

            modelBuilder.Entity("IDTPDomainModel.Models.MasterTokenDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AllowedIpOrWebsite")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("MasterTokenId");

                    b.ToTable("MasterTokenDetails");
                });
            ...
            modelBuilder.Entity("IDTPDomainModel.Models.MasterToken", b =>
                {
                    b.HasOne("IDTPDomainModel.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("IDTPDomainModel.Models.MasterTokenDetail", b =>
                {
                    b.HasOne("IDTPDomainModel.Models.MasterToken", "MasterToken")
                        .WithMany()
                        .HasForeignKey("MasterTokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
