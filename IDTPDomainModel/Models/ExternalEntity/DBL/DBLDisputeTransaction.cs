...
namespace IDTPDomainModel.Models.ExternalEntity.DBL
{
    [Table("DBLDisputeTransaction")]
    public partial class DBLDisputeTransaction : EntityAudit, IEntity
    {
        [Key]
        ...
        [InverseProperty("DBLDisputeTransactions")]
